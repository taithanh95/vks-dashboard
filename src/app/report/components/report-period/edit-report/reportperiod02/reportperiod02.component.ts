...
@Component({
  selector: 'app-reportperiod02',
  templateUrl: './reportperiod02.component.html',
  styleUrls: ['./reportperiod02.component.css']
})
export class Reportperiod02Component implements OnInit {
  ...
  ngOnInit(): void {
    this.constantService.postRequest(this.constantService.REPORT_URI + 'requestPeriodReport/getDetail/', {id: this.item.id})
  ...
  updateManual(valueManual: number, data: any): void {
    if (valueManual < 0) {
      ...
      this.constantService.postRequest(this.constantService.REPORT_URI + 'requestPeriodReport/updateValori', {
