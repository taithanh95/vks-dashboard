...
@Component({
  selector: 'app-detail-report-period',
  templateUrl: './detail-report-period.component.html',
  styleUrls: ['./detail-report-period.component.css'],
  providers: [
    {
...
export class DetailReportPeriodComponent implements OnInit {
