...
export class MauSoMuoiHaiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsTable = [
      ...
      {
        title: 'QĐ phân công/Thay đổi Kiểm sát viên (4)',
        width: '11%'
      },
      {
        title: 'QĐ Tách/Nhập vụ án (Trong giai đoạn truy tố) (5)',
        width: '11%'
      },
      {
        title: 'QĐ Chuyển/Thụ lý vụ án (Để truy tố theo thẩm quyền) (6)',
        width: '10%'
      },
      {
        title: 'QĐ gia hạn thời hạn truy tố (7)',
        width: '10%'
      },
      {
        title: 'QĐ trả hồ sơ vụ án để điều tra bổ sung (8)',
        width: '10%'
      },
      {
        title: 'QĐ tạm đình chỉ/QĐ hủy bỏ QĐ tạm đình chỉ điều tra Vụ án/Bị can (9)',
        width: '10%'
      },
      {
        title: 'QĐ đình chỉ điều tra Vụ án/Bị can (10)',
        width: '10%'
      },
      {
        title: 'QĐ hủy bỏ QĐ đình chỉ điều tra Vụ án/Bị can (11)',
        width: '10%'
      },
      {
        title: 'QĐ phục hồi điều tra Vụ án/Bị can (12)',
        width: '10%'
      },
      {
        title: 'QĐ xử lý vật chứng, tài sản bị kê biên, tài khoản bị phong tỏa (13)',
        width: '10%'
      },
      {
        title: 'QĐ chuyển vật chứng (14)',
        width: '10%'
      },
      {
        title: 'Cáo trạng/Quyết định truy tố (Theo thủ tục rút gọn) (15)',
        width: '10%'
      },
      {
        title: 'QĐ rút quyết định truy tố (16)',
        width: '10%'
      },
      {
        title: 'QĐ hủy Quyết định rút quyết định truy tố (17)',
        width: '10%'
      },
      {
        title: 'Văn bản đề nghị Tòa án trả hồ sơ để điều tra bổ sung (18)',
        width: '10%'
      },
      {
        title: 'Quyết định phân công/Thay đổi Kiểm sát viên THQCT và KSXX tại phiên tòa sơ thẩm (19)',
        width: '10%'
      },
      {
        title: 'QĐ phân công VKS cấp dưới THQCT, KSXX ST vụ án hình sự (20)',
        width: '10%'
      },
      {
        title: 'QĐ định biệt phái Kiểm sát viên THQCT, KSXX ST vụ án hình sự (21)',
        width: '10%'
      },
      {
        title: 'Văn bản thông báo về vụ án có bị can bị tạm giam (22)',
        width: '10%'
      },
      {
        title: 'Văn bản thông báo việc truy tố bị can trước tòa (23)',
        width: '10%'
      },
      {
        title: 'Ghi chú (24)',
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book12/requestReportPdf/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = 'Sổ_12_sổ_đăng_ký_lệnh_quyết_định_văn_bản_trong_giai_đoạn_truy_tố_' +
