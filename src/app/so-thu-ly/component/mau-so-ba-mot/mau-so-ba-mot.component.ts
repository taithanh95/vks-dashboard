...
export class MauSoBaMotComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsTable = [
      ...
      {
        title: 'Bản án, quyết định áp dụng biện pháp tư pháp giáo dục tại trường giáo dưỡng, bắt buộc chữa bệnh (Số; ngày, tháng, năm; Tội danh; Cơ quan ban hành) (3)',
        width: '10%'
      },
      {
        title: 'Quyết định áp dụng, thi hành biện pháp tư pháp (Số; ngày, tháng, năm; Biện pháp phải thi hành; thời hạn chấp hành; Cơ quan ban hành) (4)',
        width: '10%'
      },
      {
        title: 'Cơ quan, tổ chức được giao nhiệm vụ thi hành biện pháp tư pháp (5)',
        width: '10%'
      },
      {
        title: 'Ngày, tháng, năm thi hành biện pháp tư pháp (6)',
        width: '10%'
      },
      {
        title: 'Trốn (Ngày, tháng, năm) (7)',
        width: '10%'
      },
      {
        title: 'Chết, (Ngày, tháng, năm) (8)',
        width: '10%'
      },
      {
        title: 'Quyết định đình chỉ thi hành, hoãn, tạm đình chỉ chấp hành biện pháp tư pháp (Số; ngày, tháng, năm; Cơ quan ban hành) (9)',
        width: '10%'
      },
      {
        title: 'Quyết định chấm dứt trước thời hạn thi hành biện pháp tư pháp (Số; ngày, tháng, năm; Cơ quan ban hành) (10)',
        width: '10%'
      },
      {
        title: 'Đã chấp hành xong (Giấy chứng nhận Số; ngày, tháng, năm) (11)',
        width: '10%'
      },
      {
        title: 'Ghi chú (12)',
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book31/requestReportPdf/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = '31_Sổ_kiểm_sát_thi_hành_các_biện_pháp_tư_pháp_' +
