...
export class MauSoMuoiTamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsTable = [
      ...
      {
        title: 'Họ và tên người bị kết án (Ngày, tháng, năm sinh; Quê quán; Nơi cư trú) (2)',
        width: '12%'
      },
      {
        title: 'Bản án đã có hiệu lực pháp luật (Số; ngày, tháng, năm; Điều khoản áp dụng) (3)',
        width: '12%'
      },
      {
        title: 'Quyết định của Viện trưởng VKSND tối cao (Số; ngày, tháng, năm) (4)',
        width: '12%'
      },
      {
        title: 'Quyết định của Chánh án TAND tối cao (Số; ngày, tháng, năm) (5)',
        width: '12%'
      },
      {
        title: 'Quyết định của Chủ Tịch nước (Số; ngày, tháng, năm) (6)',
        width: '12%'
      },
      {
        title: 'Ghi chú (7)',
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book18/requestReportPdf/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = 'Sổ_18_sổ_quản_lý_người_bị_tuyên_phạt_tử_hình_' +
