...
export class MauSoNamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsTable = [
      {
        title: 'STT/ Ngày, tháng, năm thực hiện (1)',
        width: '7%'
      },
      {
        title: 'Vụ án/Bị can chính/Tội danh (Điều luật) (2)',
        width: '12%'
      },
      {
        title: 'Khám nghiệm hiện trường (3)',
        width: '11%'
      },
      {
        title: 'Khám nghiệm tử thi (4)',
        width: '11%'
      },
      {
        title: 'Khám xét VKS tham gia/ Không tham gia, lý do (5)',
        width: '11%'
      },
      {
        title: 'Thực nghiệm điều traVKS tham gia/ Không tham gia, lý do (6)',
        width: '11%'
      },
      {
        title: 'Nhận dạng VKS tham gia/ Không tham gia, lý do (7)',
        width: '11%'
      },
      {
        title: 'Đối chất VKS tham gia/ Không tham gia, lý do (8)',
        width: '11%'
      },
      {
        title: 'Nhận biết giọng nói VKS tham gia/ Không tham gia, lý do (9)',
        width: '11%'
      },
      {
        title: 'Ghi chú (10)',
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book05/requestReportPdf/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = 'Sổ_05_sổ_kiểm_sát_khám_nghiệm_hiện_trường_khám_nghiệm_tử_thi_và_các_hoạt_động_vks_tham_gia_bắt_buộc_' +
