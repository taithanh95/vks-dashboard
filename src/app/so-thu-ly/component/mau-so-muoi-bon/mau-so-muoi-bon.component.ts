...
import {Book14, Book14Search, ColsTable} from '../../model/so-thu-ly.model';
...
@Component({
  selector: 'app-mau-so-muoi-bon',
  templateUrl: './mau-so-muoi-bon.component.html',
  providers: [
    DatePipe
  ]
})
export class MauSoMuoiBonComponent implements OnInit {
  totalPages: number;
  totalRecords: number;
  ...
  ngOnInit(): void {
    ...
    const listDecisionInBook23: string[] = ['0201', '5201', '5908', '5901', '1703', '6502', '1903', '1904', '1906', '1901'];
    ...
    this.colsTable = [
      ...
      {
        title: 'Vụ án/ Bị cáo (Họ và tên; ngày, tháng, năm sinh;thường trú; Đảng viên…) (2)',
        width: '10%'
      },
      {
        title: 'Quyết định truy tố (Số; ngày, tháng, năm; Điều luật) (3)',
        width: '15%'
      },
      {
        title: 'Kiểm sát viên (4)',
        width: '9%'
      },
      {
        title: 'Thẩm phán (Chủ tọa phiên tòa) (5)',
        width: '9%'
      },
      {
        title: 'Tạm giam (Từ ngày tháng năm đến ngày tháng năm) (6)',
        width: '10%'
      },
      {
        title: 'VKS rút quyết định truy tố (7)',
        width: '10%'
      },
      {
        title: 'Quyết định của Tòa án trước khi xét xử (8)',
        width: '10%'
      },
      {
        title: 'Đưa vụ án ra xét xử (Số; ngày, tháng, năm) (9)',
        width: '10%'
      },
      {
        title: 'VKS đề nghị mức hình phạt (10)',
        width: '10%'
      },
      {
        title: 'Ngày, tháng, năm xét xử (11)',
        width: '10%'
      },
      {
        title: 'Tạm hoãn, tạm ngưng phiên tòa (Số; ngày, tháng, năm; Lý do) (12)',
        width: '10%'
      },
      {
        title: 'Bản án (Số, ngày tháng năm, nội dung) (13)',
        width: '10%'
      },
      {
        title: 'Ngày, tháng, năm TA chuyển giao BA cho VKS cung cấp (14)',
        width: '10%'
      },
      {
        title: 'Kháng cáo (Ngày tháng năm, nội dung) (15)',
        width: '10%'
      },
      {
        title: 'Kháng nghị của VKS (Số, ngày tháng năm, VKS kháng nghị, nội dung) (16)',
        width: '10%'
      },
      {
        title: 'Ghi chú (Ghi thêm các tiêu chí như: Phiên tòa rút kinh nghiệm, người bào chữa, áp dụng thủ tục rút gọn (nếu có) (17)',
        width: '6%'
      }
    ];
  }
  ...
  */
  ...
  getListData() {
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book14/requestReport/'
      , {
  ...
  exportPdf(): void {
    ...
    this.inProgress = true;
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book14/requestReportPdf/'
      , {
        'fromDate': this.datePipe.transform(this.searchModel.fromDate, 'dd/MM/yyyy'),
        'toDate': this.datePipe.transform(this.searchModel.toDate, 'dd/MM/yyyy'),
        'unitId': this.searchModel.unitId,
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = 'Sổ_14_sổ_thqct_ksxx_sơ_thẩm_các_vụ_án_hình_sự_' +
  ...
  exportExcel(): void {
    ...
    this.inProgress = true;
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book14/requestReportExcel/'
      , {
        'fromDate': this.datePipe.transform(this.searchModel.fromDate, 'dd/MM/yyyy'),
        'toDate': this.datePipe.transform(this.searchModel.toDate, 'dd/MM/yyyy'),
        'unitId': this.searchModel.unitId,
  ...
  exportDocx(): void {
    ...
    this.inProgress = true;
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book14/requestReportDocx/'
      , {
        'fromDate': this.datePipe.transform(this.searchModel.fromDate, 'dd/MM/yyyy'),
        'toDate': this.datePipe.transform(this.searchModel.toDate, 'dd/MM/yyyy'),
        'unitId': this.searchModel.unitId,
  ...
  search(searchKeyword: string): void {
    const filteredList: Book14[] = [];
    this.copyData().forEach((value: Book14) => {
