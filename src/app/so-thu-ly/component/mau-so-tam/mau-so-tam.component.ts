...
export class MauSoTamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsTable = [
      ...
      {
        title: 'QĐ khởi tố vụ án (Số; ngày, tháng năm; Cơ quan ra QĐ) (4)',
        width: '12%'
      },
      {
        title: 'QĐ khởi tố bị can (Số; ngày, tháng năm; Cơ quan ra QĐ) (5)',
        width: '12%'
      },
      {
      ...
      {
        title: 'QĐ tạm đình chỉ (Số; ngày, tháng năm; Cơ quan ra QĐ) (7)',
        width: '10%'
      },
      {
        title: 'Lý do tạm đình chỉ (Căn cứ, điều luật) (8)',
        width: '10%'
      },
      {
        title: 'QĐ truy nã bị can/QĐ đình nã/Cơ quan điều tra ra QĐ (9)',
        width: '10%'
      },
      {
        title: 'Tác động của VKS (Số; ngày, tháng, năm; Nội dung) (10)',
        width: '10%'
      },
      {
        title: 'QĐ hủy bỏ QĐ tạm ĐC Vụ án/Bị can (Số; ngày, tháng, năm; Cơ quan ban hành) (11)',
        width: '10%'
      },
      {
        title: 'Quyết định phục hồi Vụ án/Bị can (Số; ngày, tháng, năm; Cơ quan ban hành) (12)',
        width: '10%'
      },
      {
        title: 'Ghi chú (13)',
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book08/requestReportPdf/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = 'Số_08_sổ_quản_lý_án_hình_sự_tạm_đình_chỉ_' +
