...
export class TamGiamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.colsTable = [
      ...
      {
        title: 'Lệnh tạm giam để điều tra (Đối với trường hợp tạm giữ chuyển sang) (4))',
        width: '20%'
      },
      {
        title: 'Lệnh bắt bị can để tạm giam; Cơ quan ra lệnh bắt (5)',
        width: '10%'
      },
      {
        title: 'Quyết định gia hạn tạm giam (Ghi rõ lần thứ mấy) (6)',
        width: '10%'
      },
      {
        title: 'Tạm giam để điều tra truy tố bổ sung (Số, ngày, tháng, năm; Từ ngày đến ngày) (7)',
        width: '10%'
      },
      {
        title: 'Lệnh tạm giam để truy tố (8)',
        width: '10%'
      },
      {
        title: 'Lệnh bắt bị can để tạm giam (9)',
        width: '10%'
      },
      {
        title: 'Quyết định gia hạn tạm giam (10)',
        width: '10%'
      },
      {
        title: 'Lệnh tạm giam án sơ thẩm (Đối với bị can, bị cáo đang tạm giam; Lý do tạm giam) (11)',
        width: '30%'
      },
      {
        title: 'Lệnh bắt và tạm giam (Đối với bị can, bị cáo đang tại ngoại; Lý do tạm giam) (12)',
        width: '10%'
      },
      {
        title: 'Quyết định tạm giam, lý do án sơ thẩm (13)',
        width: '10%'
      },
      {
        title: 'Quyết định tạm giam, lý do án phúc thẩm (14)',
        width: '10%'
      },
      {
        title: 'Quyết định bắt và tạm giam, lý do án phúc thẩm (15)',
        width: '10%'
      }, {
        title: 'Quyết định thi hành án (Số; ngày, tháng, năm) (16)',
        width: '10%'
      },
      {
        title: 'Chuyển đi nơi khác (Ngày, tháng, năm; Lý do) (17)',
        width: '10%'
      },
      {
        title: 'Nơi khác chuyển đến (Ngày, tháng, năm; Lý do) (18)',
        width: '30%'
      },
      {
        title: 'Người bị kết án đang tại ngoại, người hết thời hạn hoãn, tạm đình chỉ tự nguyện hoặc bị áp giải đến để thi hành án (19)',
        width: '10%'
      },
      {
        title: 'Quyết định thay thế biện pháp ngăn chặn; Cơ quan ra quyết định (20)',
        width: '10%'
      },
      {
        title: 'Quyết định hủy bỏ biện pháp tạm giam; Cơ quan ra quyết định (21)',
        width: '10%'
      },
      {
        title: 'Trả tự do khi có quyết định đình chỉ (22)',
        width: '10%'
      }, {
        title: 'Trả tự do khi hết án trong thời gian kháng cáo, kháng nghị (23)',
        width: '10%'
      },
      {
        title: 'Hết thời hạn tù trong thời gian chờ quyết định chuyển đi chấp hành án (24)',
        width: '10%'
      },
      {
        title: 'Quyết định tạm đình chỉ chấp hành án (25)',
        width: '30%'
      },
      {
        title: 'Tòa án cấp sơ thẩm trả tự do tại phiên tòa; Lý do (26)',
        width: '10%'
      },
      {
        title: 'Tòa án cấp phúc thẩm trả tự do tại phiên tòa; Lý do (27)',
        width: '10%'
      },
      {
        title: 'Viện kiểm sát trả tự do theo quy định của Luật tổ chức VKSND, Luật thi hành TG,TG (28)',
        width: '10%'
      },
      {
        title: 'Đã thi hành án tử hình (29)',
        width: '10%'
      },

      {
        title: 'Quyết định bắt buộc chữa bệnh (30)',
        width: '10%'
      },
      {
        title: 'Chuyển thi hành án (31)',
        width: '10%'
      },
      {
        title: 'Ngày trốn (32)',
      ...
      {
        title: 'Quyết định truy nã (33)',
        width: '10%'
      }, {
        title: 'Ngày bắt lại (34)',
        width: '10%'
      },
      {
        title: 'Quyết định xử lý khi bắt lại (Số; ngày, tháng, năm) (35)',
        width: '10%'
      },
      {
        title: 'Vi phạm kỷ luật (Ngày, tháng, năm; Nội dung vi phạm) (36)',
        width: '30%'
      },
      {
        title: 'Quyết định xử lý vi phạm (Số; ngày, tháng, năm; Hình thức xử lý) (37)',
        width: '12%'
      },
      {
        title: 'Chết (Ngày, tháng, năm; Nguyên nhân chết) (38)',
        width: '10%'
      },
      {
        title: 'Ghi chú (39)',
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book22/requestReportPdf/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const fileName = 'Sổ_22_kiểm_sát_việc_thi_hành_tạm_giam_' +
    ...
    this.constantService.postRequest(this.constantService.REPORT_URI + 'book22/requestReportDocx/'
      ...
      .then(resJson => {
        if (resJson.responseCode === '0000') {
          ...
          const downloadLink = document.createElement('a');
          const fileName = 'Sổ_22_kiểm_sát_việc_thi_hành_tạm_giam_' + this.dateService.convertDateToStringByPattern(Date.now(), 'yyyyMMdd_HHmmss') + '.docx';
          downloadLink.href = linkSource;
          downloadLink.download = fileName;
          downloadLink.click();
        } else {
