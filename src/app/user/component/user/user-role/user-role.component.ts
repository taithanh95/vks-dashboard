...
export class UserRoleComponent implements OnInit {
  ...
  save(): void {
    this.isLoading = true;
    this.constantService.postRequest(this.constantService.AUTH_URI + 'role/setUserRole/'
      , {
        'userId': this.userId,
        'items': this.items
      }).toPromise()
  ...
  getListData() {
    this.isLoading = true;
    this.constantService.postRequest(this.constantService.AUTH_URI + 'role/findUserRole/'
      , {
        'userId': this.userId
      }).toPromise()
      .then(res => res.json())
